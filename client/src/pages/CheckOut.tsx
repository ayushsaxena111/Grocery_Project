...
import { ArrowLeftIcon, CheckIcon, ChevronRightIcon, CreditCardIcon, MapPin, MapPinIcon } from "lucide-react"
        ...
        return (
            <div className="min-h-screen bg-app-cream flex-center">
                <div className="text-center">
                    ...
                    <p className="text-sm text-app-text-light mb-4">Add some items to checkout</p>
                    <button className="px-5 py-2.5 bg-app-green text-white text-sm font-medium rounded-xl hover:bg-app-green-light transition-colors" onClick={()=>navigate('/products')} >Browse Products</button>
                </div>
            </div>
        )
    }
