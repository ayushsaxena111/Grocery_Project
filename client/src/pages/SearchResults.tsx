            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20">
                        ...
                        <p className="text-sm text-app-text-light mb-6 max-w-md mx-auto">We couldnnot find any products matching "{query}"" . Try a different search term.</p>
                        <Link to='/products' className="inline-flex px-5 py-2.5 bg-app-green text-white text-sm font-medoum rounded-lg">
                        Browse All products
                        </Link>
                    </div>
                ) : (
