...
const Products = () => {
    ...
    return (
        <div className="min-h-screen bg-app-cream">
                    ...
                    <main className="flex-1">
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-16">
                               ...
                               <p className="text-sm text-app-text-light mb-4"> Try adjusting your search filters or terms</p>
                        ...
                        {totalPages > 1 && (
                            <div className="flex-center gap-2 mt-16">
                                {Array.from({length: totalPages}).map((_,i)=>(
                                    <button key={i} onClick={()=>{updateFilter("page",String(i+1));scrollTo(0,0)}} className={`size-9 rounded-lg text-sm font-medium transition-colrs ${page===i+1 ? "bg-app-green text-white" : "bg-white text-app-text-light hover:bg-app-cream"}`}>
                                        {i+1}
                                    </button>
                                ))}
                            </div>
            ...
            {mobileFilterOpen && (
                <>
                <div className="fixed inset-0nbg-black/40 z-50" onClick={()=>setMobileFilterOpen(false)} />
