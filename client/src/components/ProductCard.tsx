    ...
    return (
        <div className="bg-white rounded-2xl overflow-hidden shadow hover:shadow-md transition-all duration-300 group animate-fade-in cursor-pointer" onClick={()=>navigate(`/products/${product._id}`)}>
            <div className="relative aspect-square overflow-hidden">
                <img src={product.image} alt={product.name} className="w-full h-full object-cover p-4 group-hover:p-2 trasition-all duration-300" />
            ...
            <div className="p-3.5 text-zinc-700">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button onClick={(e)=>{e.stopPropagation(); addToCart(product)}} className="sized-7 rounded-full bg-app-orange text-white flex-center shrink-0 hover:bg-app-orange-dark transition-colors active:scale-95">
